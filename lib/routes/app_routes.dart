...
import 'package:UrbanEraFashion/Login/Welcome.dart';
...
import 'package:UrbanEraFashion/views/category/filters_view.dart';
import 'package:UrbanEraFashion/views/category/offers_view.dart';
import 'package:UrbanEraFashion/views/category/rating_and_reviews_view.dart';
...
import 'package:UrbanEraFashion/views/home/notification_view.dart';
import 'package:UrbanEraFashion/views/home/search_view.dart';
import 'package:UrbanEraFashion/views/my_address/add_address_view.dart';
import 'package:UrbanEraFashion/views/my_address/edit_address_view.dart';
import 'package:UrbanEraFashion/views/my_address/my_address_view.dart';
import 'package:UrbanEraFashion/views/on_boarding/on_boarding_view.dart';
import 'package:UrbanEraFashion/views/order_summary/offers_promotions_view.dart';
import 'package:UrbanEraFashion/views/order_summary/order_summary_view.dart';
import 'package:UrbanEraFashion/views/payment/card_details_view.dart';
import 'package:UrbanEraFashion/views/payment/payment_view.dart';
import 'package:UrbanEraFashion/views/profile/edit_profile_view.dart';
import 'package:UrbanEraFashion/views/profile/profile_tabs/customer_care_view.dart';
import 'package:UrbanEraFashion/views/profile/profile_tabs/languages_view.dart';
import 'package:UrbanEraFashion/views/profile/profile_tabs/my_order/add_reviews_view.dart';
import 'package:UrbanEraFashion/views/profile/profile_tabs/my_order/my_orders_view.dart';
import 'package:UrbanEraFashion/views/profile/profile_tabs/my_order/order_details_view.dart';
import 'package:UrbanEraFashion/views/profile/profile_tabs/my_order/order_status_view.dart';
import 'package:UrbanEraFashion/views/profile/profile_tabs/my_review_view.dart';
import 'package:UrbanEraFashion/views/profile/profile_tabs/notifications_view.dart';
import 'package:UrbanEraFashion/views/profile/profile_tabs/returns_policy_view.dart';
import 'package:UrbanEraFashion/views/profile/profile_tabs/save_for_later_view.dart';
import 'package:UrbanEraFashion/views/profile/profile_tabs/terms_and_conditions_view.dart';
import 'package:UrbanEraFashion/views/profile/profile_tabs/who_we_are_view.dart';
